        ...
        <nav className={scrolled ? 'scrolled' : ''}>
            <div className='nav_content container'>
                ...
                <ul className={`links ${links ? 'open' : ''}`}>
                    ...
                    <li className='mob_reserve_button'><Link onClick={() => setLinks(false)} to={'/login'}>Daxil ol</Link></li>
                </ul>
                <div className='desk_reserve_button'><Link to={'/login'}>Daxil ol</Link></div>
